    ...
    public static final List<Feed> feeds = new ArrayList<Feed>() {
        {
            ...
            add(new Feed("https://almogaz.com/rss", Category.CategoryNames.LATEST_NEWS, Website.WebsiteNames.ALMOGAZ));
            add(new Feed("https://almogaz.com/rss/politics", Category.CategoryNames.POLITICS, Website.WebsiteNames.ALMOGAZ));
            add(new Feed("https://almogaz.com/rss/sports", Category.CategoryNames.SPORTS, Website.WebsiteNames.ALMOGAZ));
            add(new Feed("https://almogaz.com/rss/art-culture", Category.CategoryNames.CULTURE, Website.WebsiteNames.ALMOGAZ));
            add(new Feed("https://almogaz.com/rss/art-culture", Category.CategoryNames.ARTS, Website.WebsiteNames.ALMOGAZ));
            add(new Feed("https://almogaz.com/rss/crime", Category.CategoryNames.ACCIDENTS, Website.WebsiteNames.ALMOGAZ));
            add(new Feed("https://almogaz.com/rss/economy", Category.CategoryNames.FINANCE, Website.WebsiteNames.ALMOGAZ));
            add(new Feed("https://almogaz.com/rss/tech", Category.CategoryNames.TECHNOLOGY, Website.WebsiteNames.ALMOGAZ));
